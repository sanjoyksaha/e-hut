                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.color.store') }}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 text-right control-label col-form-label">Color Name <sup class="text-danger">*</sup></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Color Name" value="{{ old('name') }}">
                                        @error('name')
