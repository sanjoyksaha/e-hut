                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.unit.store') }}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 text-right control-label col-form-label">Unit Name <sup class="text-danger">*</sup></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Unit Name" value="{{ old('name') }}">
                                        @error('name')
